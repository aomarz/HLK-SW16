...
\n\n
\texample#1: $0 192.168.16.254:8080\n\
\t(Get each relay status of HLK-SW16 located at 192.168.16.254 port 8080)\n\
...
#OUTPUT=`ncat 192.168.16.254:8080 -c "bash -c \"echo -e '$PREFIX$PREFIX2$SWITCHID$SWITCHTO$SUFFIX';sleep 1\""`
#another try ncat 192.168.16.254:8080 -c "bash -c '(echo hello;sleep 3;read -n100 -d\"\\0x00\" abc;echo $abc)'"
